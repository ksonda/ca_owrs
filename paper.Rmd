...
own <- ear %>% 
    filter(QuestionName == "Population" | 
                QuestionName == "Water System Classification" |
                QuestionName == "Water System Ownership" |
                QuestionName == "IsWholesaler") %>% 
    mutate(QuestionID=paste0("q",QuestionID)) %>%
...
own_inv <- left_join(inv,own,by="PWSID")
